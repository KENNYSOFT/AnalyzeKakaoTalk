...
public class AnalyzeKakaoTalk
{
	Connection connection,connection2;
	Statement statement,statement2;
	
	public AnalyzeKakaoTalk() throws SQLException
	{
	...
	void getFiles() throws IOException,InterruptedException
	{
		...
		while((sLine=br.readLine())!=null)
		{
			...
			{
				proc=Runtime.getRuntime().exec(("assets\\adb pull "+sLine.substring("package:".length())+" KakaoTalk.apk").split(" "));
